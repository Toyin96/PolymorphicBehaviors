...
//    }
//
//    public BasePlusCommissionEmployee(String firstName, String lastName, String socialSecurityNumber, double commissionRate, double grossSales, double baseSalary, int day, int month, int year) {
//        super(firstName, lastName, socialSecurityNumber, day, month, year, commissionRate, grossSales);
//        if (baseSalary <= 0){
//            throw new IllegalArgumentException("Base salary cannot be less than or equal to zero");
//        }
//        this.baseSalary = baseSalary;
